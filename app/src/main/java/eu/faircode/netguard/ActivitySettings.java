...
//        screen.findPreference("vpn4").setTitle(getString(R.string.setting_vpn4, prefs.getString("vpn4", "10.1.10.1")));
        screen.findPreference("vpn4").setTitle(getString(R.string.setting_vpn4, prefs.getString("vpn4", Util.getLocalIPAddress(true))));
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String name) {
        ...
        if ("screen_on".equals(name))
            ...
            getPreferenceScreen().findPreference(name).setTitle(
                    ...
                    getString(R.string.setting_vpn4, prefs.getString(name, Util.getLocalIPAddress(true)));
            ServiceSinkhole.reload("changed " + name, this, false);
